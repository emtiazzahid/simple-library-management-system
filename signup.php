<?php 
      ...
      if(isset($_POST['signup']))
      {
        ...
        {
             move_uploaded_file($_FILES['file']['tmp_name'],'img/proPic/'.$picture);
             mysqli_query($cn,"INSERT INTO accounts(username,age,homeAddress,email,password,phoneNo,gender,picture,picturename) VALUES('$Name','$age','$homeAddress','$email','$password','$phoneNo','$gender','$picture','$picturename')");
              echo  "<script>
